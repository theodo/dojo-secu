 ...
 */
final class Version20190516114335 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE army RENAME COLUMN password TO access_code');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE army RENAME COLUMN access_code TO password');
    }
}
