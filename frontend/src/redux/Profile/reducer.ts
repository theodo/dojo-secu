...
import {fetchUserRoles, goToLevelTwo, goToLevelFour} from './actions';
import User from './types';

export type ProfileAction = ActionType<typeof goToLevelFour | typeof goToLevelTwo | typeof fetchUserRoles>;
